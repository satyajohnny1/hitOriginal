...
<html>
    <head>
        ...
        <!-- Title -->
        <title>HitandFut | Datatables</title>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        ...
                                        <li role="presentation"><a href="empty.php"><i class="fa fa-sign-out m-r-xs"></i>Log out</a></li>
                                    </ul>
                               </a>
                                </li>
                                <li>
                                    <a href="empty.php" class="log-out waves-effect waves-button waves-classic">
                        ...
                        <div class="col-md-12">
						    ...
						    <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <button type="button" class="btn btn-success m_b_sm" data-toggle="modal" data-target="#myModal">Confirm</button>
                                </div>
                            </div>
                                    ...
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>61</td>
                                                <td>2011/04/25</td>
                                                <td> <button type="button" class="btn btn-success m_b_sm" data-toggle="modal" data-target="#myModal">Distribute</button></td>
                                            </tr>
                                            <tr>
