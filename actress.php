                                    ...
                                    <form action="updateallpage.php" method="POST" enctype="multipart/form-data">
                                      ...
                                      <?php 
                                        include 'db.php';
                             			...
                             			$sql = "SELECT * FROM tolly_actress WHERE actress_id = ".$acid;
                                             		//	echo $sql;
                                                    			...
                                                    			if (mysqli_num_rows($result) > 0) {
																	...
																	$rate 	= $row["actress_rate"];
																	$grade 	= $row["actress_grade"];
																	$status = $row["actress_status"];
																	$rating = $row["actress_rating"];
																	$pic 	= $row["actress_pic"];
									  ...
									  <div class="form-group">
									   ...
									   <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $acid ?>" id="aid" name="aid" placeholder="aid">
                                        </div>
