                                    ...
                                    <form action="updateallpage.php" method="POST" enctype="multipart/form-data">
                                      ...
                                      <?php 
                                        include 'db.php';
                             			...
                             			$sql = "SELECT * FROM tolly_writer WHERE writer_id = ".$wid;
                                             		//	echo $sql;
                                                    			...
                                                    			if (mysqli_num_rows($result) > 0) {
																	...
																	$rate 	= $row["writer_rate"];
																	$grade 	= $row["writer_grade"];
																	$status = $row["writer_status"];
																	$rating = $row["writer_rating"];
																	$pic 	= $row["writer_pic"];
									  ...
									  <div class="form-group">
									   ...
									   <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $wid ?>" id="aid" name="aid" placeholder="aid">
                                        </div>
