                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        include 'db.php';
                                        $uid = $_SESSION['s_uid'];
                                        $sql = "SELECT s.rid, s.title, s.dname, s.aname, s.result, s.collection, s.sofar,
                                                       COALESCE(r.`50d_cen`, 0) AS c50,
                                                       COALESCE(r.`100d_cen`, 0) AS c100
                                                FROM tolly_ready_for_shoot s
                                                LEFT JOIN tolly_release r
                                                       ON r.rid = s.rid AND r.status = 'out'
                                                WHERE s.uid = ".$uid." and s.status = 'out'";
                                        //echo $sql;
