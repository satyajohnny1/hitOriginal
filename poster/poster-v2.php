...
if ($hero_count === 1) {
	drawHero($jpg_image, "actors/" . clean(strtolower($a)) . ".png", 300);
} elseif ($hero_count === 2) {
	drawHero($jpg_image, "actors/" . clean(strtolower($a)) . ".png", 450);
	drawHero($jpg_image, "actors/" . clean(strtolower($a2)) . ".png", 100);
} else {
	drawHero($jpg_image, "actors/" . clean(strtolower($a)) . ".png", 300);
	drawHero($jpg_image, "actors/" . clean(strtolower($a2)) . ".png", 70);
	drawHero($jpg_image, "actors/" . clean(strtolower($a3)) . ".png", 550);
}

$hit_img = safe_imagecreatefrompng("actors/hit.png", 190, 190);
