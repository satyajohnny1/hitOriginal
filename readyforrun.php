          			 		 ...
          			 		 <div class="cd-pricing-container">                                    
                                        <ul class="cd-pricing-list cd-bounce-invert">
                                         ...
                                         //   echo $rid;        					
											...
											echo "<li><em>REVIEW :</em> ".$budget."</li>";											 
											echo "</ul>";
											echo "</div>";
											echo "<footer class='cd-pricing-footer'>";																				
											echo "<a class='cd-select' href='running.php?rid=".$rid."'>Box Office :)</a>";
											echo "</footer>";
											echo "</li>                                             ";
											echo "</ul>";
											echo "</li>";
                                        ...
                                        <h2>You Don't have Any Movies on Running!! Go To <a href=\"makemovie.php\">Make Movie</a></h2>
                                    </div> ";
                                                    			}
