...
<body class="page-header-fixed">
    ...
    <form class="search-form" action="actressupload.php" method="GET">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <form action="actressupload.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pic" value="/pic/u1.jpeg" value="/pic/u1.jpeg" name="pic" placeholder="Name">
                                        </div>
                                        <div class="form-group">
