...
$rating = $_POST ["rating"];
$upname = clean($name);
		$sql1 = "INSERT INTO `hit`.`director` (`director_name`, `director_rate`, `director_grade`, `director_pic`, `director_status`, `director_rating`) VALUES 		
		('$name', $rate, '$grade', '$pic','$status','$rating')";
