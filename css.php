        <title>HiT&Flop - The Ultimate Movie Simulation Game</title>
        ...
        <script src="assets/plugins/offcanvasmenueffects/js/snap.svg-min.js"></script>
         	...
         	<link href="own/flipclock.css" rel="stylesheet" type="text/css" />
            <script type="text/javascript" src="own/flipcounter.js"></script>
            <!-- Counter styles -->
            <link rel="stylesheet" type="text/css" href="own/style.css" />
            <link rel="stylesheet" href="own/odometer-theme-car.css" />
             <link rel="stylesheet" href="own/own.css" />
			<script src="own/odometer.js"></script>
