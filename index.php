...
<?php
error_log("[INDEX_PAGE] session_check: s_uid=" . ($_SESSION['s_uid'] ?? 'NOT_SET') . " login_user=" . ($_SESSION['login_user'] ?? 'NOT_SET') . " sid=" . session_id());
if(isset($_SESSION['s_uid'])){
error_log("[INDEX_PAGE] already logged in uid={$_SESSION['s_uid']}, redirecting to dashboard");
